...
using OptionalDeviceTypeAlias = std::optional<std::string>;
...
public:
        ...
        struct DeviceTypeData{
            ...
            OptionalDeviceTypeAlias alias;
        };

        // using NO_ALIAS = std::nullopt;

        using RegistryType = std::vector<DeviceTypeData>;
        using Iterator = RegistryType::iterator;

        static const OptionalDeviceTypeAlias NO_ALIAS;
        ...
        static DeviceType CreateDeviceType(const std::string& label, const DevicePlatform platform, const OptionalDeviceTypeAlias alias);
    ...
    private:
        /// data container to hold the data of the device_type
